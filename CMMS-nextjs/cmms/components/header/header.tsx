                            ...
                            <form className="flex gap-2">
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button className="hidden lg:flex bg-slate-100 lg:h-10 hover:bg-slate-200 text-[18px] rounded-s font-bold border-blue-300" variant="outline">Vật liệu xây dựng <IoIosArrowDown /></Button>
                                    </DropdownMenuTrigger>
                                ...
                                <div className="flex w-full max-w-sm items-center">
                                    <Input type="search" placeholder="Tìm kiếm" className="w-full lg:h-10 lg:text-2xl lg:w-[200px] xl:w-[250px] 2xl:w-[500px]" />
                                                                    ...
                                                                    {products.map((product) => (
                                                                        <tr key={product.id} className="border-b">
                                                                            ...
                                                                            <td className="py-2 px-4">
                                                                                ...
                                                                                <button className="px-2 py-2" onClick={decrement}>
                                                                                    -
                                                                                </button>
                                                                                <input
                                                                                    type="text"
                                                                                ...
                                                                                />
                                                                                <button className="px-2 py-2" onClick={increment}>
                                                                                    +
                                                                                </button>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td className="px-4">
                                                                                <HoverCard openDelay={50} closeDelay={100}>
                                                                                    <HoverCardTrigger>
                                                                                        <RiDeleteBin6Line className="text-red-400 hover:text-red-500" size={25} />
                                                                                    </HoverCardTrigger>
                                                                                    <HoverCardContent
                                                                                        side="top"
